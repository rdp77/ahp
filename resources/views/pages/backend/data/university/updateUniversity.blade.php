...
<div class="breadcrumb-item active">{{ __('Edit Universitas') }}</div>
@endsection
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="email" class="form-control" value="{{ $university->email }}" required>
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
                        <label>{{ __('Kode') }}<code>*</code></label>
                        <input type="text" name="code" class="form-control" value="{{ $university->code }}" required>
                    </div>
                    <div class=" form-group">
                        <label>{{ __('No Telepon') }}<code>*</code></label>
                        <input type="text" name="phone" class="form-control" value="{{ $university->phone }}" required>
                    </div>
                </div>
            </div>
            <div class="form-group">
